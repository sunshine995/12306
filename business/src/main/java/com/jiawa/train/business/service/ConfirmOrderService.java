...
import com.jiawa.train.business.enmus.ConfirmOrderStatusEnum;
import com.jiawa.train.business.enmus.SeatColEnum;
import com.jiawa.train.business.enmus.SeatTypeEnum;
...
public class ConfirmOrderService {
    ...
    public void doConfirm(ConfirmOrderSaveReq req){
        ...
        ConfirmOrderTicketReq ticketReq0 = tickets.get(0); // 得到第一个车票
     ...
     * @param seatType 座位类型
     * @param column 第一个座位列号
     * @param offsetList 偏移值
     */
    ...
    private static void reduceTickets(ConfirmOrderSaveReq req, DailyTrainTicket dailyTrainTicket) {
