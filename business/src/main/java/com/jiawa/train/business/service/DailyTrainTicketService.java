...
import com.jiawa.train.business.enmus.TrainTypeEnum;
...
public class DailyTrainTicketService {
    ...
    // 生成那一天的那一个车次的余票信息
    // 批量操作都要考虑事务，要不全部成功，或者跑多少算多少。
    @Transactional
    public void getDaily(daily_train dailyTrain, Date date, String trainCode){
        LOG.info("开始日期【{}】车次【{}】的余票信息开始", DateUtil.formatDate(date), trainCode);
        ...
        if (CollUtil.isEmpty(stationList)) {
            LOG.info("该车次没有座位基础数据，生成该车次的余票信息结束");
            return;
        }
